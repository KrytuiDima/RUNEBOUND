...
export class SpellEffectManager {
    ...
    createFireCircle(position, scale) {
    ...
    update(time) { this.scene.traverse((obj) => { if (obj instanceof THREE.Mesh && obj.material instanceof THREE.ShaderMaterial) {
        if (obj.material.uniforms.time)
            obj.material.uniforms.time.value = time;
    } }); }
}
//# sourceMappingURL=SpellEffectManager.js.map